...
public class DragonFlier2
{
    ...
    private class GamePane extends JPanel {
        ...
        private void initialize(){
            ...
            this.messageBox = new MessageBox(dragon, background, FRAME_WIDTH, FRAME_HEIGHT, 
            "Dragon Flier Instructions /Collect 12 eggs when they are ready (Blue with a red dot)/Press SPACE : Fireball/Press R : Restart /Press I : Toggle Instructions/Press ↑ : Go Up/Press ↓: Go Down/Press →: Go Right/Press ←: Go Left ");
            ...
            addKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_R, 0, true), "R pressed: restarting game", 
                                                                                new R_Action(this));
           addKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_I, 0, true), "Toggling message box", new I_Action(messageBox));                                                                             
        }
    ...
    //Probably need an instance variables to refer back to the message box
    //Take in messageBox instead of GamePane
    public class I_Action extends AbstractAction {
        MessageBox messageBoxSetting;
        public I_Action(MessageBox mb){
            this.messageBoxSetting = mb;
        }
        @Override
        public void actionPerformed(ActionEvent e) {
            System.out.println("You typed 'I' so toggling the instructions!");
            this.messageBoxSetting.setDisplay();//Toggles the messageBox
